...
namespace AqueaductoApp.CapaVistas
{
    public partial class FrmModificarConsumo : Form
    {
                ...
                else
                {
                   if(string.IsNullOrEmpty(this.labelFecha.Text))
                   ...
                   else
                    {
                        ...
                        cT.ModificarConsumo(this.txtCatastro.Text, this.labelFecha.Text, month,consumo);
        ...
        private void FrmModificarConsumo_Load(object sender, EventArgs e)
        {
            // TODO: esta línea de código carga datos en la tabla 'dataSet1.CONSUMOS' Puede moverla o quitarla según sea necesario.
            this.cONSUMOSTableAdapter.Fill(this.dataSet1.CONSUMOS);
        ...
        private void GridConsumo_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            fecha = GridConsumo.CurrentRow.Cells[2].Value.ToString();
            this.labelFecha.Text = fecha;
            this.labelFecha.Visible = true;


            string consumo = GridConsumo.CurrentRow.Cells[4].Value.ToString();
            this.txtConsumo.Text = consumo;
            this.txtConsumo.Visible = true;
            month = (int)GridConsumo.CurrentRow.Cells[3].Value;
